...
const NeoCardSettingsContent = ({ query, refreshRate, cypherParameters, width, height, type,
    ...
    const settings = REPORT_TYPES[type]["settingsComponent"] ? <SettingsComponent type={type} query={query} onQueryUpdate={onQueryUpdate} /> :
    <>
