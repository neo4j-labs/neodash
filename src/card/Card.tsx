...
const NeoCard = ({
    ...
    const SouthEastArrow = () => (
        <svg width="10px" height="10px" version="1.1" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
    ...
    const cardResizeStyle= {
        paddingBottom: "0px", paddingLeft: "0px", paddingRight: "0px", paddingTop: "0px", width: "100%",
