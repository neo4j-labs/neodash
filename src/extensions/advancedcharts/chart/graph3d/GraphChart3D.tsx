...
import { NeoGraphChartDeepLinkButton } from '../../../../chart/graph/component/button/GraphChartDeepLinkButton';
import { NeoGraphChartCanvas } from '../../../../chart/graph/component/GraphChartCanvas';
import { NeoGraphChartLockButton } from '../../../../chart/graph/component/button/GraphChartLockButton';
import { NeoGraphChartFitViewButton } from '../../../../chart/graph/component/button/GraphChartFitViewButton';
import { buildGraphVisualizationObjectFromRecords } from '../../../../chart/graph/util/RecordUtils';
import { parseNodeIconConfig } from '../../../../chart/graph/util/NodeUtils';
import { GraphChartVisualizationProps, Link, layouts } from '../../../../chart/graph/GraphChartVisualization';
import { handleExpand } from '../../../../chart/graph/util/ExplorationUtils';
import { categoricalColorSchemes } from '../../../../config/ColorConfig';
import { IconButtonArray, IconButton } from '@neo4j-ndl/react';
import { Tooltip } from '@mui/material';
import { downloadCSV } from '../../../../chart/ChartUtils';
import { generateSafeColumnKey } from '../../../../chart/table/TableChart';
import { GraphChartContextMenu } from '../../../../chart/graph/component/GraphChartContextMenu';
import { getSettings } from '../../../../chart/SettingsUtils';
  ...
  return (
    <div ref={observe} style={{ width: '100%', height: '95%' }}>
      <NeoGraphChartCanvas>
        ...
        <NeoGraphChartVisualization3D {...chartProps} />
