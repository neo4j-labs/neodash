...
RETURN code,totalCount
  ...
  },
  {
    ...
    syntheticQuery: `
        WITH [
            {
                path: {  start: {labels: ["Task"], elementId: "1", properties: {name: "Task A", startDate: "2023-10-10",  endDate: "2023-10-11"}},  end:  {elementId: "2"},  length: 1, segments: [ { start: {labels: ["Task"], elementId: "1", properties: {name: "Task A", startDate: "2023-10-10",  endDate: "2023-10-11"}}, relationship: {type: "NEXT", startNodeElementId: "1", endNodeElementId: "2", elementId: "10001", properties: {rel_type: 'ES'}}, end: {labels: ["Task"], elementId: "2",properties: {name: "Task B", startDate: "2023-10-11",  endDate: "2023-10-12"}} } ] }, person: "Jim", movie: "The Matrix", rating: 4.5
            },
            {
                path: {  start: {labels: ["Task"], elementId: "2", properties: {name: "Task B", startDate: "2023-10-11",  endDate: "2023-10-12"}},  end:  {elementId: "3"},  length: 1, segments: [ { start: {labels: ["Task"], elementId: "2", properties: {name: "Task B", startDate: "2023-10-11",  endDate: "2023-10-12"}}, relationship: {type: "NEXT", startNodeElementId: "2", endNodeElementId: "3", elementId: "10002", properties: {rel_type: 'EE'}}, end: {labels: ["Task"], elementId: "3",properties: {name: "Task C", startDate: "2023-10-12",  endDate: "2023-10-13"}} } ] }, person: "Mike", movie: "The Matrix", rating: 3.8
            },
            {
                path: {  start: {labels: ["Task"], elementId: "3", properties: {name: "Task C", startDate: "2023-10-12",  endDate: "2023-10-13"}},  end:  {elementId: "4"},  length: 1, segments: [ { start: {labels: ["Task"], elementId: "3", properties: {name: "Task C", startDate: "2023-10-12",  endDate: "2023-10-13"}}, relationship: {type: "NEXT", startNodeElementId: "3", endNodeElementId: "4", elementId: "10003", properties: {rel_type: 'SE'}}, end: {labels: ["Task"], elementId: "4",properties: {name: "Task D", startDate: "2023-10-13",  endDate: "2023-10-14"}} } ] }, person: "Sarah", movie: "The Matrix", rating: 5.0
            },
            {
                path: {  start: {labels: ["Task"], elementId: "4", properties: {name: "Task D", startDate: "2023-10-13",  endDate: "2023-10-14"}},  end:  {elementId: "5"},  length: 1, segments: [ { start: {labels: ["Task"], elementId: "4", properties: {name: "Task D", startDate: "2023-10-13",  endDate: "2023-10-14"}}, relationship: {type: "NEXT", startNodeElementId: "4", endNodeElementId: "5", elementId: "10004", properties: {rel_type: 'SS'}}, end: {labels: ["Task"], elementId: "5", properties: {name: "Task E", startDate: "2023-10-14",  endDate: "2023-10-15"}} } ] }, person: "Jim", movie: "The Matrix - Reloaded", rating: 3.5
            }
          ] as data
          UNWIND data as row
          RETURN row.path as Path
