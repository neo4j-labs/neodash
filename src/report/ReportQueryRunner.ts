...
export async function runCypherQuery(driver,
    ...
    parameters = {},
    rowLimit = 1000,
    setStatus = (status) => { console.log("Query runner attempted to set status: " + JSON.stringify(status))},
    setRecords = (records) => { console.log("Query runner attempted to set records: " + JSON.stringify(records))},
    setFields = (fields) => { console.log("Query runner attempted to set fields: " + JSON.stringify(fields))},
    fields = [],
