 ...
 */
export const NeoDashboardHeaderPageList = ({ open, standalone, editable, pages, pagenumber, addPage, movePage, removePage, selectPage, setPageTitle }) => {
    ...
    function recomputeLayout() {
        ...
        setLastElement(<div key={timestamp}
            style={{
                background: "inherit",
